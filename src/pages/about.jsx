...
function About() {
  return (
    <main className="bg-white">
      <SEO
        title="About Us"
        description="Learn about the Dynamite Opens Scrabble Tournament, our mission, vision, and history."
      />
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="uppercase font-black text-4xl sm:text-6xl lg:text-7xl text-green-950 leading-tight tracking-tighter">
            About Dynamite{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-600 to-amber-500">
              Open
            </span>
          </h1>
          ...
          <p className="mt-8 text-gray-600 font-medium text-lg sm:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed">
            ...
            excellence. Joining minds together since inception.
          </p>
        </div>
      </section>
      ...
      {/* TIMELINE */}
      <section
        className="bg-[#0a2e1f] py-24 relative overflow-hidden"
        data-aos="fade-up"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="mt-6 text-gray-500 max-w-2xl mx-auto font-medium text-lg">
              The foundation of Dynamite Opens and the strategic direction we
              are moving toward.
            </p>
          </div>
            ...
            <div className="group relative" data-aos="fade-right">
              ...
              <div className="relative rounded-4xl sm:rounded-[2.5rem] bg-white border border-green-100 p-8 sm:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.04)] transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-2xl h-full">
                ...
                <p className="text-gray-600 leading-relaxed text-lg font-medium">
                  To provide an inclusive and dynamic platform for grassroots
                  Scrabble development in Nigeria, fostering youth empowerment,
                  competitive excellence, and community engagement while
                  building a lasting intellectual sporting brand.
                </p>
              </div>
            </div>
