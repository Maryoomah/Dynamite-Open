            ...
            <h3 className="mb-4 text-xl font-bold leading-none text-white">Step 3</h3>
                <div className="bg-black rounded-md p-4 border-2 border-gold my-6">
                    <ul className="my-2 text-white flex flex-col items-center gap-2">
                        <h3 className="font-bold text-white">Welcome to Emmanuel Egbele Scrabble Tournament (Trilogy Edition) By registering for the tournament, you agree to the following terms and conditions:</h3>

                        <li className="text-xs">1. Eligibility: The tournament is open to all individuals aged 18 years or older. Participants must register and pay the registration fee before the deadline specified by the organizers</li>

                        <li className="text-xs">2. Conduct: Participants must behave in a respectful and sportsmanlike manner at all times. Cheating or unsportsmanlike conduct will result in disqualification.</li>

                        <li className="text-xs">3. Liability: The tournament organizers are not responsible for any injuries or damages sustained by participants during the tournament.</li>

                        <li className="text-xs">4. Prizes: Prizes will be awarded to the top performers, and are non-transferable and non-exchangeable.</li>
